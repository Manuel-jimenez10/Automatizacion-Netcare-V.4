...
const getContactIdFromExternalScript = (phone) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
class WhatsappController {
    ...
    static handleIncomingMessage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                contactId = yield getContactIdFromExternalScript(phone);
                ...
                if (contactId) {
                    ...
                    conversations = yield espoClient.searchEntities('WhatsappConverstion', [
                        {
                            type: 'equals',
                ...
                const newMessage = yield espoClient.createEntity('WhatsappMessage', newMessageData);
                ...
                if (conversationId) {
                    ...
                    yield espoClient.updateEntity('WhatsappConverstion', conversationId, {
                        description: Body,
    ...
    static handleOutgoingMessage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const message = yield (0, twilio_service_1.sendTextMessage)({
                    phone,
                    text,
                ...
                if (message.sid) {
                    yield espoClient.updateEntity('WhatsappMessage', entity.id, {
    ...
    static handleStatusUpdate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const messages = yield espoClient.searchEntities('WhatsappMessage', [
                    {
                        type: 'equals',
                ...
                if (newStatus !== messages[0].status) {
                    yield espoClient.updateEntity('WhatsappMessage', messageId, {
                        status: newStatus
                    });
                }
...
const taskCompleted = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { sendTaskCompletedMessage } = yield Promise.resolve().then(() => __importStar(require('../services/twilio.service')));
        yield sendTaskCompletedMessage({
            phone,
            clientName,
            taskName
        });
