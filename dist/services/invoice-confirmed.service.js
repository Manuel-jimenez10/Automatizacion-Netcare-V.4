...
exports.InvoiceConfirmedService = void 0;
...
class InvoiceConfirmedService {
        ...
        try {
            ...
            if (hasXml) {
                ...
                if (xmlFiles.length > 0) {
                    ...
                    xml_pending_store_1.xmlPendingStore.set(phoneValidation.formattedNumber, xmlFiles, invoice.name);
     ...
     */
    async logMessageInEspo(invoice, phone, clientName, twilioResponse) {
...
exports.InvoiceConfirmedService = InvoiceConfirmedService;
