...
export const env = {
  ...
  whatsappInfoEnabled:
    (process.env.WHATSAPP_INFO_ENABLED || 'true').toLowerCase() !== 'false',
  ...
  whatsappInfoTextFormat:
    process.env.WHATSAPP_INFO_TEXT_FORMAT ||
  ...
  whatsappInfoUseWindow:
    (process.env.WHATSAPP_INFO_USE_WINDOW || 'true').toLowerCase() !== 'false',
  ...
  whatsappInfoRequireSecret:
    (process.env.WHATSAPP_INFO_REQUIRE_SECRET || 'false').toLowerCase() === 'true',
