...
import { sendQuotePresentedMessage } from './twilio.service';
import { env } from '../config/env';
import { EspoCRMQuote, PhoneValidation } from '../interfaces/interfaces';

export class QuotePresentedService {
   ...
   */
  async handleQuotePresented(quoteId: string): Promise<void> {
    console.log('\n🚀 ============================================');
    ...
    try {
      ...
      const twilioResponse = await sendQuotePresentedMessage({
